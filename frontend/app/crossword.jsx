       ...
       return (
           <div className="text-white font-[Itim]">
               ...
               {isEditing ? (
                   ...
                   <div className="flex flex-col md:flex-row gap-2 w-full max-w-full overflow-hidden">
   
                       {/* Left Column */}
                       <div className="flex flex-col gap-2 w-full md:w-[350px] max-w-full shrink-0">
                           ...
                           <div className="bg-[#522136] p-4 rounded-lg">
                               ...
                               <button
                                   ...
                                   onClick={async () => {
                                       if (!puzzleTitle || !qnaList.length || !grid.length || !placedWords.length) {
                                           alert("Please enter puzzle title, at least one question, and generate the puzzle first.");
                                           return;
                                       }
                                       ...
                                       try {
                                           ...
                                           if (!res.ok) {
                                               console.warn("Failed to save puzzle");
                                               return;
                                           }
                                           ...
                                           // 🔁 Redirect to solve screen!
                                           router.push(`/solve/${puzzleId}`);
                                       } catch (err) {
                       ...
                       {/* Right Column */}
                       {/* Puzzle look */}
                       <div className={`bg-[#522136] p-2 rounded-lg ${screenWidth > 770
                           ? "md:w-3/5 min-w-0 max-w-full overflow-hidden flex flex-col gap-2"
                           : "w-full md:w-3/5 min-w-0 flex flex-col gap-2"
                           }`}>
                           ...
                           >
                               <div
                                   ...
                                   style={{
                                       ...
                                       transformOrigin: "top left",  // ✅ makes scale behave properly
                                       width: "max-content",         // ✅ makes sure it's scrollable, not stretched
                                   }}
                               >
